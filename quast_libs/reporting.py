...
####################################################################################
    ...
    order = [NAME, CONTIGS__FOR_THRESHOLDS, TOTALLENS__FOR_THRESHOLDS, CONTIGS, LARGCONTIG, TOTALLEN, REFLEN, ESTREFLEN, GC, REFGC,
             N50, NG50, N75, NG75, L50, LG50, L75, LG75, E_SIZE,
             ...
             LARGALIGN, TOTAL_ALIGNED_LEN, EAMEANMAX, STRICT_EAMEANMAX, EA50MAX, STRICT_EA50MAX, EA75MAX, STRICT_EA75MAX, P5K, P10K, P15K, P20K, STRICT_P5K, STRICT_P10K, STRICT_P15K, STRICT_P20K, NGA50, NGA75, LGA50, LGA75, EA_SIZE,
    ...
    grouped_order = [
        ('Genome statistics', [MAPPEDGENOME, DUPLICATION_RATIO, AVE_READ_SUPPORT, GENES, OPERONS,
                               ...
                               EAMEANMAX, EA50MAX, EA75MAX, STRICT_EA50MAX, STRICT_EA75MAX, P5K, P10K, P15K, P20K, STRICT_P5K, STRICT_P10K, STRICT_P15K, STRICT_P20K, NG50, NG75, NA50, NA75, NGA50, NGA75, LG50, LG75, LA50, LA75, LGA50, LGA75, EA_SIZE, BUSCO_COMPLETE, BUSCO_PART]),
    ...
    quality_dict = {
        Quality.MORE_IS_BETTER:
            [LARGCONTIG, TOTALLEN, TOTALLENS__FOR_THRESHOLDS, TOTALLENS__FOR_1000_THRESHOLD, TOTALLENS__FOR_10000_THRESHOLD,
             ...
             N50, NG50, N75, NG75, NA50, NGA50, NA75, NGA75, E_SIZE, EA_SIZE, EAMEANMAX, STRICT_EAMEANMAX, EA50MAX, STRICT_EA50MAX, EA75MAX, STRICT_EA75MAX, P5K, P10K, P15K, P20K, STRICT_P5K, STRICT_P10K, STRICT_P15K, STRICT_P20K,
