...
####################################################################################
    ...
    UNIQUE_EXTENSIVE_MISASSEMBLIES = '# unique misassemblies'
    UNIQUE_LOCAL_MISASSEMBLIES = '# unique local misassemblies'
    ...
    EA_SIZE_MAX = "EA_SIZE_MAX"
    E_SIZE_MAX = "E_SIZE_MAX"
    EAMEANMAX = "EAmeanmax"
    EMEANMAX = "Emeanmax"
    STRICT_EAMEANMAX = "Strict EAmeanmax"
    EA5MAX = "EA5max"
    EA10MAX = "EA10max"
    EA15MAX = "EA15max"
    EA20MAX = "EA20max"
    ...
    EA45MAX = "EA45max"
    EA50MAX = "EA50max"
    STRICT_EA5MAX = "Strict EA5max"
    STRICT_EA10MAX = "Strict EA10max"
    STRICT_EA15MAX = "Strict EA15max"
    STRICT_EA20MAX = "Strict EA20max"
    STRICT_EA25MAX = "Strict EA25max"
    STRICT_EA30MAX = "Strict EA30max"
    STRICT_EA35MAX = "Strict EA35max"
    STRICT_EA40MAX = "Strict EA40max"
    STRICT_EA45MAX = "Strict EA45max"
    STRICT_EA50MAX = "Strict EA50max"
    E50MAX = "E50max"
    NG50 = 'NG50'
    NA50 = 'NA50'
    NGA50 = 'NGA50'
    ...
    P15K = 'P15k'
    P20K = 'P20k'
    STRICT_P5K = 'Strict P5k'
    STRICT_P10K = 'Strict P10k'
    STRICT_P15K = 'Strict P15k'
    STRICT_P20K = 'Strict P20k'
    ...
    order = [NAME, CONTIGS__FOR_THRESHOLDS, TOTALLENS__FOR_THRESHOLDS, CONTIGS, LARGCONTIG, TOTALLEN, REFLEN, ESTREFLEN, GC, REFGC,
             ...
             LARGE_MIS_EXTENSIVE, MISASSEMBL, UNIQUE_EXTENSIVE_MISASSEMBLIES, MISCONTIGS, MISCONTIGSBASES,
             MISLOCAL, UNIQUE_LOCAL_MISASSEMBLIES, MIS_SCAFFOLDS_GAP, MIS_LOCAL_SCAFFOLDS_GAP,
             ...
             LARGALIGN, TOTAL_ALIGNED_LEN, EAMEANMAX, STRICT_EAMEANMAX,
             EA5MAX,
             EA10MAX,
             EA15MAX,
             EA20MAX,
             ...
             STRICT_EA40MAX,
             STRICT_EA45MAX,
             STRICT_EA50MAX, EA75MAX, STRICT_EA75MAX, P5K, P10K, P15K, P20K, STRICT_P5K, STRICT_P10K, STRICT_P15K, STRICT_P20K, NGA50, NGA75, LGA50, LGA75,
    ...
    grouped_order = [
        ('Genome statistics', [MAPPEDGENOME, DUPLICATION_RATIO, AVE_READ_SUPPORT, GENES, OPERONS,
                               ...
                               EAMEANMAX,
                               EA5MAX, EA10MAX, EA15MAX, EA20MAX, EA25MAX, EA30MAX, EA35MAX, EA40MAX, EA45MAX, EA50MAX,  STRICT_EA5MAX, STRICT_EA10MAX, STRICT_EA15MAX, STRICT_EA20MAX, STRICT_EA25MAX, STRICT_EA30MAX, STRICT_EA35MAX, STRICT_EA40MAX, STRICT_EA45MAX, STRICT_EA50MAX,
                               EA75MAX, STRICT_EA75MAX, P5K, P10K, P15K, P20K, STRICT_P5K, STRICT_P10K, STRICT_P15K, STRICT_P20K, NG50, NG75, NA50, NA75, NGA50, NGA75, LG50, LG75, LA50, LA75, LGA50, LGA75, BUSCO_COMPLETE, BUSCO_PART]),
    ...
    quality_dict = {
        Quality.MORE_IS_BETTER:
            [LARGCONTIG, TOTALLEN, TOTALLENS__FOR_THRESHOLDS, TOTALLENS__FOR_1000_THRESHOLD, TOTALLENS__FOR_10000_THRESHOLD,
             ...
             N50, NG50, N75, NG75, NA50, NGA50, NA75, NGA75, EMEANMAX, E50MAX, E75MAX, EAMEANMAX, STRICT_EAMEANMAX, EA5MAX, EA10MAX, EA15MAX, EA20MAX, EA25MAX, EA30MAX, EA35MAX, EA40MAX, EA45MAX, EA50MAX,  STRICT_EA5MAX, STRICT_EA10MAX, STRICT_EA15MAX, STRICT_EA20MAX, STRICT_EA25MAX, STRICT_EA30MAX, STRICT_EA35MAX, STRICT_EA40MAX, STRICT_EA45MAX, STRICT_EA50MAX, EA75MAX, STRICT_EA75MAX, P5K, P10K, P15K, P20K, STRICT_P5K, STRICT_P10K, STRICT_P15K, STRICT_P20K,
